...
public class TinyDB {
     ...
     * @param theBitmap    the image you want to save as MyLiveEarthLocation Bitmap
    ...
    /**
     * Saves the Bitmap as MyLiveEarthLocation PNG file at path 'fullPath'
     *
     * @param fullPath path of the image file
     * @param bitmap   the image as MyLiveEarthLocation Bitmap
    ...
    public String getString2(String key) {
        return preferences.getString(key, "MM/dd/yy//time");
    }
    /**
...
//    }
     ...
     *
     * @return MyLiveEarthLocation Map representing MyLiveEarthLocation list of key/value pairs from SharedPreferences
     */
